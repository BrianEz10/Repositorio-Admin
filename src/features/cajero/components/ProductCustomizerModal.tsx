      ...
      <div className="bg-surface-container border border-outline-variant/20 w-full max-w-md mx-4 flex flex-col max-h-[80vh]">
        ...
        <div className="px-6 py-4 border-t border-outline-variant/20 flex gap-3 shrink-0">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 px-4 py-2.5 bg-primary text-on-primary text-label-md font-bold hover:brightness-110 transition-all disabled:opacity-40 cursor-pointer"
          >
            Agregar al carrito
          </button>
        </div>
