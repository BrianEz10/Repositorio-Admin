  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-surface-container border border-outline-variant/20 w-full max-w-md mx-4 p-8 flex flex-col items-center gap-6 text-center">
        ...
        <button
          onClick={onClose}
          className="w-full bg-primary text-on-primary py-3 text-label-md font-bold uppercase tracking-wider hover:brightness-110 active:scale-[0.98] transition-all cursor-pointer"
        >
          Nuevo Pedido
        </button>
      </div>
