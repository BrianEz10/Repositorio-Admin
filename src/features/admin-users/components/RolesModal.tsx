...
export default function RolesModal({ user, allRoles, onSubmit, onClose, isSubmitting }: RolesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-surface-container border border-outline-variant/20 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-primary text-on-primary text-label-md font-bold hover:brightness-110 transition-all disabled:opacity-50 flex items-center gap-2 cursor-pointer"
            >
              {isSubmitting ? (
                <>
